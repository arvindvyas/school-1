...
(function() {
  ...
  this.Gmaps4RailsBing = (function(superClass) {
    extend(Gmaps4RailsBing, superClass);
    ...
    Gmaps4RailsBing.prototype.extendBoundsWithMarkers = function() {
      var i, len, locationsArray, marker, ref;
      locationsArray = [];
      ref = this.markers;
      for (i = 0, len = ref.length; i < len; i++) {
        marker = ref[i];
...
(function() {
  ...
  this.Gmaps4RailsMapquest = (function(superClass) {
    extend(Gmaps4RailsMapquest, superClass);
    ...
    Gmaps4RailsMapquest.prototype.extendBoundsWithMarkers = function() {
      ...
      if (this.markers.length >= 2) {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          marker = ref[i];
          results.push(this.boundsObject.extend(marker.serviceObject.latLng));
        }
        return results;
      }
    };
...
(function() {
  ...
  this.Gmaps4RailsOpenlayers = (function(superClass) {
    extend(Gmaps4RailsOpenlayers, superClass);
    ...
    Gmaps4RailsOpenlayers.prototype.extendBoundsWithMarkers = function() {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        marker = ref[i];
        results.push(this.boundsObject.extend(this.createLatLng(marker.lat, marker.lng)));
      }
      return results;
    };
      ...
      funcs = {
        context: {
          width: function(feature) {
            var ref;
            return (ref = feature.cluster) != null ? ref : {
              2: 1
            };
          },
    ...
    Gmaps4RailsOpenlayers.prototype.create_polyline = function(polyline) {
      var clickable, element, i, latlng, len, line_points, line_style, polyline_coordinates, strokeColor, strokeOpacity, strokeWeight, zIndex;
...
(function() {
  $(document).ready(function() {
    return $(".text .description a").attr("target", "_blank");
  });

}).call(this);
(function() {
  $(document).on("blur", ".content form.new_user input#user_email", function() {
    return $(this).mailcheck({
      suggested: function(element, suggestion) {
        ...
        return $('form.new_user #suggestion').show();
      },
      empty: function(element) {
        return $('form.new_user #suggestion').hide();
      }
    });
  });

  $(document).on("click", "a[data-action='choose-suggested-email']", function() {
...
(function() {
  $(document).on("click", ".rsvp a[data-must-login='true']", function(e) {
    var lesson_id;
    lesson_id = $(this).closest(".rsvp").data("id");
...
(function() {
  $(document).ready(function() {
    return $(document).on("click", ".show_map", function(e) {
      e.preventDefault();
      return $(".the_map").stop().animate({
        opacity: 1,
        height: "450px"
      });
    });
